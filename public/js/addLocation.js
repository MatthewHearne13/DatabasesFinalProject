...
addLocationForm.addEventListener("submit", function (e) {
    ...
    let inputLocationType = document.getElementById("dropdownLocationTypeSelect");
...
addRowToTable = (data) => {
    ...
    idCell.innerText = newRow.idLocation;
    ...
    deleteCell.onclick = function(){
        deleteRowLocation(newRow.idLocation);
    };
    ...
    row.setAttribute('location-value', newRow.idLocation);
